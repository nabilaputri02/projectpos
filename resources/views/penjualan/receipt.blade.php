...
<body>
    <p>invoice:{{ $datatransaksi->invoice}}<br>pelangan:{{ $datatransaksi->pelangan->nama}}<br>Cashier:{{ Auth::user()->nama}}
    <br>Tanggal:{{$datatransaksi->created_at->format('d M Y H:m')}}</p>
    <table>
        <thead>
            <tr>
                <td>produk</td>
